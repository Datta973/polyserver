...
class Rectangle {
  ...
  contains(circle) {
    return ((circle.x + circle.radius > this.x - this.w && circle.y + circle.radius > this.y - this.h) && (circle.x - circle.radius < this.x + this.w && circle.y - circle.radius < this.y + this.h))
