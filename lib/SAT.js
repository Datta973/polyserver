...
(function (root, factory) {
   ...
   * @return {Vector} This for chaining.
   */
  Vector.prototype['rotate'] = Vector.prototype.rotate = function (angle,centroid) {
    var x = this['x'];
    var y = this['y'];
    this['x'] = ( (x - centroid.x ) * Math.cos(angle)) - ( ( y - centroid.y ) * Math.sin(angle)) + centroid.x;
    this['y'] = ( (x - centroid.x ) * Math.sin(angle)) + ( ( y - centroid.y )  * Math.cos(angle)) + centroid.y;
    return this;
  };
  ...
  Polygon.prototype['rotate'] = Polygon.prototype.rotate = function(angle) {
    ...
    for (var i = 0; i < len; i++) {
      points[i].rotate(angle,this['pos']);
    }
    this._recalc();
    return this;
  };
